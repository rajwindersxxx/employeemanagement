...
CREATE TABLE `leave-applied` (
  ...
  `apply-date` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `salary` (
  ...
  `date-only` datetime NOT NULL DEFAULT current_timestamp(),
  `action` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `services-applied` (
  `Applyed-date` datetime NOT NULL DEFAULT current_timestamp(),
  `id` int(30) NOT NULL,
  `emp-id` varchar(30) NOT NULL,
