        ...
        <div class="wrapper">
            ...
            <div id="two">
                <div class="my-box" style="height: 84vh;">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="width: 100%; overflow-x: auto;">
                        <div class="search">
                            <div class="row">
                            ...
                            <div class="row">
                                <input type="submit" class="a-button" value="Search" name="search-date">
                            </div>
                        </div>
                    </form>
                    <div class="continer">
                        <form id="form" method="post" style="height: 51vh;overflow: auto;">
                            <table class="table table-bordered text-center" id="myTable">
                                <tr class="bg-dark text-white">
                                    <th onclick="sortNumber(0)">Serail No</th>
                                    <th onclick="sortTable(1)">Applied Time</th>
                                    <th onclick="sortTable(2)">Application No</th>
                                ...
                                $stmt = $conn->prepare("SELECT `id`,`date-time`, `customer-name`, `customer-number`, `dept-name`, `service-type`, `quantity`, `total-cost`, `emp-id`
                       FROM `services-applied` WHERE `emp-id` ='$emp_id' and `applyed-date` BETWEEN :from_date AND :to_date ORDER BY id DESC");
                                ...
                                foreach ($result as $row) {
                                    ...
                                    echo "<td>" . str_pad($row["id"], 8, '0', STR_PAD_LEFT) . "</td>";
